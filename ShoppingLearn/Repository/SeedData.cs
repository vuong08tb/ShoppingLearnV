		...
		public static void SeedingData(DataContext _context)
		{
			...
			if (!_context.Products.Any())
			{
				...
				_context.Products.AddRange(
					new ProductModel { Name = "MacBook", Slug = "Macbook", Description = "Macbook is the best", Image = "1.jpg", Category = macbook,Brand = apple, Price = 1200 },
					new ProductModel { Name = "Pc", Slug = "pc", Description = "Pc is the best", Image = "1.jpg", Category = pc,Brand = samsung, Price = 1200 }
				);
			}
